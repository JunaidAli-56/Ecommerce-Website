    ...
    return (
        <div className="container-fluid"   >
            <div className="row pc-upper-div">
                <div className="col-3 m-0 p-2 product-card-main-div border-style">
                ...
                <div className="col-3 m-0 p-2 product-card-main-div border-no-right">
                    <div className="py-3 ps-1">
            ...
            <div className="row pc-lower-div">
                <div className="col-3 m-0 p-2 product-card-main-div border-no-bottom">
                    <div className="py-3 ps-1">
                ...
                <div className="col-3 m-0 p-2 product-card-main-div ">
                    <div className="py-3 ps-1">
